...
module.exports = async (client, interaction, args) => {
    ...
    return Promise.all(promises)
        .then(async results => {
            ...
            client.embed({
                title: `ℹ・Bot informations`,
                desc: `____________________________`,
                thumbnail: client.user.avatarURL({ size: 1024 }),
                fields: [
                    {
                        name: "ℹ️┆Information",
                        value: `c'est un bot avec lequel vous pouvez exécuter l'intégralité de votre serveur ! Avec pas moins de 350+ commandes, nous avons un gros bot avec de nombreuses options pour améliorer votre serveur !`,
                        inline: false,
                    },
                    {
                        name: "_____ \n\n│General",
                    ...
                    {
                        name: "🔗┆Links",
                        value: `Ajoute moi: [[Ici]](${client.config.discord.botInvite}) \nServeur Support: [[HERE]](${client.config.discord.serverInvite})`,
                        inline: false,
                    }],
                type: 'editreply'
            }, interaction)
